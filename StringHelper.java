...
/**
 * Created by avlad18 on 10/9/2016.
 */
public class StringHelper {
    ...
    public static String computeSha1OfString(final String message) throws UnsupportedOperationException,
            ...
            return computeSha1OfByteArray(message.getBytes((Charset.forName("ISO-8859-1"))));
    }
    ...
    public static byte[] strRepeat(byte[] base,char chr,int limit){
        String data = convertBytesToString(base);
        ...
        return convertStringToByte(data);
    }
